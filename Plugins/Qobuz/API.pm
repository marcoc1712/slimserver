...
sub _get {
    ...
    #Data::Dump::dump("_get",$url, $token, $aid);
    
	Slim::Networking::SimpleAsyncHTTP->new(
		sub {
			my $response = shift;
			
            #Data::Dump::dump("API SimpleAsyncHTTP CALLBACK response: ", $response);
            #Data::Dump::dump("API SimpleAsyncHTTP CALLBACK params: ", $params);
            
			my $result = eval { from_json($response->content) };
            
            #Data::Dump::dump("API SimpleAsyncHTTP CALLBACK result: ", $result);
            #Data::Dump::dump("API SimpleAsyncHTTP CALLBACK callaback: ", $cb);
