...
#######################################################################
# Test cases Output codec == flc compression level=8.
#######################################################################

###################################################
# FFMPEG_resampling_flc
#
# incodec=wav;
#

sub test_wav_noSplit_FFMPEG_resampling_flc8{
...
# incodec=aif;
#
sub test_aif_noSplit_FFMPEG_resampling_flc8 {
...
# incodec=flc;
#
sub test_flc_noSplit_FFMPEG_resampling_flc8{
...
###############################################################################
# FFMPEG_noResampling_flc
#
# incodec=wav;
#

sub test_wav_noSplit_FFMPEG_noResampling_flc8{
	
	Test::TestSettings::noSplit_wav();
	Test::TestSettings::FFMPEG_noResampling_flc8();
	
	return 'G":\Sviluppo\slimserver\Bin\MSWin32-x86-multi-thread\flac.exe" -cs --totally-silent --compression-level-8 -- "F:\Classica\aaa - Resampling\wav_16_44100.wav"';
}
sub test_wav_split_noStart_end_FFMPEG_noResampling_flc{
	
	Test::TestSettings::split_wav_noStart_end();
	Test::TestSettings::FFMPEG_noResampling_flc8();
	
	return 'G":\Sviluppo\slimserver\Bin\MSWin32-x86-multi-thread\flac.exe" -cs --totally-silent --compression-level-8 --until=11:31.26 -- "F:\Classica\Albinoni, Tomaso\Albinoni Adagios - Anthony Camden, Julia Girdwood (1993 Naxos)\Albinoni - Adagio.wav"';
}
sub test_wav_split_start_end_FFMPEG_noResampling_flc8{
	
	Test::TestSettings::split_wav_start_end();
	Test::TestSettings::FFMPEG_noResampling_flc8();

	return 'G":\Sviluppo\slimserver\Bin\MSWin32-x86-multi-thread\flac.exe" -cs --totally-silent --compression-level-8 --skip=24:46.02 --until=28:24.06 -- "F:\Classica\Albinoni, Tomaso\Albinoni Adagios - Anthony Camden, Julia Girdwood (1993 Naxos)\Albinoni - Adagio.wav"';
}
sub test_wav_split_start_noEnd_FFMPEG_noResampling_flc8{

	Test::TestSettings::split_wav_start_noEnd();
	Test::TestSettings::FFMPEG_noResampling_flc8();
	
	return 'G":\Sviluppo\slimserver\Bin\MSWin32-x86-multi-thread\flac.exe" -cs --totally-silent --compression-level-8 --skip=61:56.42 --until=65:42.93 -- "F:\Classica\Albinoni, Tomaso\Albinoni Adagios - Anthony Camden, Julia Girdwood (1993 Naxos)\Albinoni - Adagio.wav"';
}
# incodec=aif;
#
sub test_aif_noSplit_FFMPEG_noResampling_flc8{
	
	Test::TestSettings::noSplit_aif();
	Test::TestSettings::FFMPEG_noResampling_flc8();
	
	return 'G":\Sviluppo\slimserver\Bin\MSWin32-x86-multi-thread\flac.exe" -cs --totally-silent --compression-level-8 -- "F:\Classica\aaa - Resampling\aiff_16_44100.aiff"';
}
sub test_aif_split_noStart_end_FFMPEG_noResampling_flc8{

	Test::TestSettings::split_aif_noStart_end();
	Test::TestSettings::FFMPEG_noResampling_flc8();
	
	return 'G":\Sviluppo\slimserver\Bin\MSWin32-x86-multi-thread\flac.exe" -cs --totally-silent --compression-level-8 --until=5:04.93 -- "F:\Classica\aaa - Resampling\Pergolesi Stabat Mater; Scarlatti 3 concerti grossi - Berganza, Freni, Gracis (1989 Archiv)\cd.aiff"';
}
sub test_aif_split_start_end_FFMPEG_noResampling_flc8{
	
	Test::TestSettings::split_aif_start_end();
	Test::TestSettings::FFMPEG_noResampling_flc8();
	
	return 'G":\Sviluppo\slimserver\Bin\MSWin32-x86-multi-thread\flac.exe" -cs --totally-silent --compression-level-8 --skip=16:54.09 --until=20:28.26 -- "F:\Classica\aaa - Resampling\Pergolesi Stabat Mater; Scarlatti 3 concerti grossi - Berganza, Freni, Gracis (1989 Archiv)\cd.aiff"';
}
sub test_aif_split_start_noEnd_FFMPEG_noResampling_flc8{
	
	Test::TestSettings::split_aif_start_noEnd();
	Test::TestSettings::FFMPEG_noResampling_flc8();
	
	return 'G":\Sviluppo\slimserver\Bin\MSWin32-x86-multi-thread\flac.exe" -cs --totally-silent --compression-level-8 --skip=68:04.42 --until=69:01.60 -- "F:\Classica\aaa - Resampling\Pergolesi Stabat Mater; Scarlatti 3 concerti grossi - Berganza, Freni, Gracis (1989 Archiv)\cd.aiff"';
}
# incodec=flc;
#
sub test_flc_noSplit_FFMPEG_noResampling_flc8{
...
sub test_flc_split_noStart_end_FFMPEG_noResampling_flc8{
	...
	return 'G":\Sviluppo\slimserver\Bin\MSWin32-x86-multi-thread\flac.exe" -cs --totally-silent --compression-level-8 --until=11:52.00 -- "F:\Classica\aaa - Resampling\Adagio Karajan (Les Rendez-Vous de DG edition)\Adagio.flac"';
}
sub test_flc_split_start_end_FFMPEG_noResampling_flc8{

	Test::TestSettings::split_flc_start_end();
	Test::TestSettings::FFMPEG_noResampling_flc8();
	
	return 'G":\Sviluppo\slimserver\Bin\MSWin32-x86-multi-thread\flac.exe" -cs --totally-silent --compression-level-8 --skip=34:03.00 --until=41:50.00 -- "F:\Classica\aaa - Resampling\Adagio Karajan (Les Rendez-Vous de DG edition)\Adagio.flac"';
}
sub test_flc_split_start_noEnd_FFMPEG_noResampling_flc8{
	
	Test::TestSettings::split_flc_start_noEnd();
	Test::TestSettings::FFMPEG_noResampling_flc8();

	return 'G":\Sviluppo\slimserver\Bin\MSWin32-x86-multi-thread\flac.exe" -cs --totally-silent --compression-level-8 --skip=72:50.00 --until=78:53.00 -- "F:\Classica\aaa - Resampling\Adagio Karajan (Les Rendez-Vous de DG edition)\Adagio.flac"';
}

###############################################################################
# NO_FFMPEG_resampling_flc
#
# incodec=wav;
#

sub test_wav_noSplit_NO_FFMPEG_resampling_flc8{
...
# incodec=aif;
#
sub test_aif_noSplit_NO_FFMPEG_resampling_flc8{
...
# incodec=flc;
#
sub test_flc_noSplit_NO_FFMPEG_resampling_flc8{
...
###############################################################################
# NO_FFMPEG_noResampling_flc
#
# incodec=wav;
#
sub test_wav_noSplit_NO_FFMPEG_noResampling_flc8{
...
sub test_wav_split_noStart_end_NO_FFMPEG_noResampling_flc8{
...
sub test_wav_split_start_end_NO_FFMPEG_noResampling_flc8{
...
sub test_wav_split_start_noEnd_NO_FFMPEG_noResampling_flc8{
...
# incodec=aif;
#
sub test_aif_noSplit_NO_FFMPEG_noResampling_flc8{
...
sub test_aif_split_noStart_NO_FFMPEG_end_noResampling_flc8{
...
sub test_aif_split_start_end_NO_FFMPEG_noResampling_flc8{
...
sub test_aif_split_start_noEnd_NO_FFMPEG_noResampling_flc8{
...
# incodec=flc;
#
sub test_noSplit_flac_NO_FFMPEG_noResampling_flc8{
...
sub test_flc_split_start_end_NO_FFMPEG_noResampling_flc8{
...
sub test_flc_split_start_noEnd_NO_FFMPEG_noResampling_flc8{
